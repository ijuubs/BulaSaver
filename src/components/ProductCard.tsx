  ...
  return (
    ...
    <article 
      ...
      <div className="p-5 flex items-start justify-between relative">
        ...
        <div className="w-40 h-40 sm:w-56 sm:h-56 flex-shrink-0 relative flex items-center justify-center group-hover:scale-105 transition-transform duration-500">
